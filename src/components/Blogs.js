...
import IMG from '../assets/images/bg/blog1.png';
    ...
    return(
        ...
        <div className="container">
            <div className="grid grid-cols-1 pb-8 text-center">
                ...
                Stay updated with the latest trends, tips, and insights in web design and development.
                Explore expert articles, project updates, and industry news to keep you informed and inspired.</p>
            </div>
