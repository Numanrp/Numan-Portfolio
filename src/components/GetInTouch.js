        ...
        <section className="relative md:py-24 py-16 bg-gray-50 dark:bg-slate-800" id="contact">
            <div className="container">
                <div className="grid grid-cols-1 pb-8 text-center">
                    ...
                    <p className="text-slate-400 max-w-xl mx-auto text-[15px]">Have a project in mind or need a professional website?
                        Let’s connect and bring your ideas to life with clean, modern web development.
                        ...
                        <div className="lg:ms-8">
                            <div className="flex">
                                ...
                                <div className="flex-1 ms-6">
                                    ...
                                    <Link to="tel:+152534-468-854" className="text-slate-400 text-[15px]">+92 3268805957</Link>
                                </div>
                            </div>
                            ...
                            <div className="flex mt-4">
                                ...
                                <div className="flex-1 ms-6">
                                    ...
                                    <Link to="mailto:contact@example.com" className="text-slate-400 text-[15px]">Numanrp786@gmail.com</Link>
                                </div>
                            </div>
                            ...
                            <div className="flex mt-4">
                                ...
                                <div className="flex-1 ms-6">
                                    ...
                                    <p className="text-slate-400 text-[15px] mb-2">Pakistan,Lahore Shad Bag Cantt</p>
                                </div>
                            </div>
                        </div>
                    </div>
