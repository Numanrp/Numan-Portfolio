...
import logoNav from "../assets/images/lowite.png";
    ...
    return(
        ...
        <div className="container flex flex-wrap items-center justify-between">
            <Link to= "/index" className="navbar-brand md:me-8" href="index.html">
                <img src={logoNav} width={200} height={200} className="inline-block dark:hidden" alt=""/>
                <img src={logoNav} width={200} height={200} className="hidden dark:inline-block" alt=""/>
            </Link>
